...
values 
('Shot C.Plata','Pending',3,180,true),
('Shot C.Reposad','Pending',3,180,true),
('Shot Sauza','Pending',3,180,true),
('Shot Hornitos','Pending',3,180,true),
('Shot H.de Tepa','Pending',3,180,true),
('Shot H.Plata','Pending',3,180,true),
('Shot H.Reposado','Pending',3,180,true),
('Shot M.Dobel','Pending',3,180,true),
('Shot 1800','Pending',3,180,true),
('Shot Don Julio','Pending',3,180,true),
('Shot H. Ultra','Pending',3,180,true),
('Cuba C.Plata','Pending',3,180,true),
('Cuba C.Reposad','Pending',3,180,true),
('Cuba Sauza','Pending',3,180,true),
('Cuba Hornitos','Pending',3,180,true),
('Cuba H.de Tepa','Pending',3,180,true),
('Cuba H.Plata','Pending',3,180,true),
('Cuba H.Reposado','Pending',3,180,true),
('Cuba M.Dobel','Pending',3,180,true),
('Cuba 1800','Pending',3,180,true),
('Cuba Don Julio','Pending',3,180,true),
('Cuba H. Ultra','Pending',3,180,true);

insert into products (name, description, category_id, base_price, is_active)
values 
('Mojito Frutos Rojos','Pending',6,180,true),
('Mojito Natural','Pending',6,180,true),
('Mojito Mango','Pending',6,180,true),
('Cubanito','Pending',6,180,true),
('Bomba','Pending',6,180,true),
('Mezcal grande','Pending',6,180,true),
('Mezcal Chico','Pending',6,180,true),
('Piña Colada','Pending',6,180,true),
('Margarita','Pending',6,180,true),
('Vampiro','Pending',6,180,true),
('Paloma C.Plata','Pending',6,180,true),
('Perla Negra','Pending',6,180,true),
('Hierba Mala','Pending',6,180,true);

insert into products (name, description, category_id, base_price, is_active)
VALUES
('Corona','Pending',1,180,true),
('Victoria','Pending',1,180,true),
('Cubeta','Pending',1,180,true),
('Litro de cerveza','Pending',1,180,true);

insert into products (name, description, category_id, base_price, is_active)
VALUES
('Michelada Corona Ch','Pending',2,180,true),
('Michelada Victoria Ch','Pending',2,180,true),
('Michelada Corona G','Pending',2,180,true),
('Michelada Victoria G','Pending',2,180,true),
('Gringa Corona Ch','Pending',2,180,true),
('Gringa Victoria Ch','Pending',2,180,true),
('Gringa Corona G','Pending',2,180,true),
('Gringa Victoria G','Pending',2,180,true),
('Preparada Corona Ch','Pending',2,180,true),
('Preparada Victoria Ch','Pending',2,180,true),
('Preparada Corona G','Pending',2,180,true),
('Preparada Victoria G','Pending',2,180,true),
('Chelada Corona Ch','Pending',2,180,true),
('Chelada Victoria Ch','Pending',2,180,true),
('Chelada Corona G','Pending',2,180,true),
('Chelada Victoria G','Pending',2,180,true);

insert into products (name, description, category_id, base_price, is_active)
values 
('Servicio C.Plata','Pending',4,180,true),
('Servicio C.Reposad','Pending',4,180,true),
('Servicio Sauza','Pending',4,180,true),
('Servicio Hornitos','Pending',4,180,true),
('Servicio H.de Tepa','Pending',4,180,true),
('Servicio H.Plata','Pending',4,180,true),
('Servicio H.Reposado','Pending',4,180,true),
('Servicio M.Dobel','Pending',4,180,true),
('Servicio 1800','Pending',4,180,true),
('Servicio Don Julio','Pending',4,180,true),
('Servicio H. Ultra','Pending',4,180,true);

insert into products (name, description, category_id, base_price, is_active)
values 
('Rusa','Pending',5,180,true),
('Limonada','Pending',5,180,true),
('Naranjada','Pending',5,180,true),
('Frappe','Pending',5,180,true),
('Smotee','Pending',5,180,true),
('Agua natural','Pending',5,180,true),
('Refresco/Agua mineral','Pending',5,180,true),
