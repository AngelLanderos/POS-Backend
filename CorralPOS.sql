...
-- Table Definition
CREATE TABLE "public"."bar_table" (
    "table_id" int4 NOT NULL,
    "table_number" int4,
    "status" varchar,
    "created_at" timestamp DEFAULT '2025-09-25 21:21:32.806717'::timestamp without time zone,
    "provisionalTotal" int4,
    PRIMARY KEY ("table_id")
);

-- Table Definition
CREATE TABLE "public"."daily_total" (
    "id" int4 NOT NULL,
    "total" int4
);
...
CREATE TABLE "public"."order_accounts" (
    "order_account_id" int4 NOT NULL,
    "order_id" int4,
    "customer_name" varchar,
    "status" varchar,
    "total" numeric,
    "created_at" timestamp DEFAULT '2025-09-25 21:21:32.853834'::timestamp without time zone
);

-- Table Definition
CREATE TABLE "public"."order_item_modifiers" (
    "order_item_modifier_id" int4 NOT NULL,
    "order_item_id" int4,
    "modifier_id" int4,
    "price_adjustment" numeric
);
...
CREATE TABLE "public"."order_items" (
    ...
    "discount" numeric,
    "notes" text,
    "created_at" timestamp DEFAULT '2025-09-25 21:21:32.86139'::timestamp without time zone,
    "paid_quantity" int4 DEFAULT 0,
...
CREATE TABLE "public"."orders" (
    ...
    "table_id" int4,
    "status" varchar,
    "created_at" timestamp DEFAULT '2025-09-25 21:21:32.848644'::timestamp without time zone,
    "closed_at" timestamp,
...
CREATE TABLE "public"."payment_allocation" (
    "payments_allocation_id" int4 NOT NULL,
    "payment_id" int4,
    "order_item_id" int4,
    "amount" numeric,
    "created_at" date,
...
CREATE TABLE "public"."payments" (
    ...
    "method" varchar,
    "reference" varchar,
    "paid_at" timestamp DEFAULT '2025-09-25 21:21:32.879075'::timestamp without time zone
);
...
CREATE TABLE "public"."users" (
    ...
    "created_at" timestamp DEFAULT '2025-09-25 21:21:32.761196'::timestamp without time zone
);

-- Table Definition
CREATE TABLE "public"."waitress_tables" (
    "waitress_table_id" int4 NOT NULL,
    "waitress_id" int4,
    "table_id" int4,
    "assigned_at" timestamp DEFAULT '2025-09-25 21:21:32.873016'::timestamp without time zone,
